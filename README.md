...
**Live demo:** **[https://redline-ai-legal-risk-detector.vercel.app](https://redline-ai-legal-risk-detector.vercel.app)** — upload a contract or use the sample to run the full review in the browser.
